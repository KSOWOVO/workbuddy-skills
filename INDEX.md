...
| `90-tooling/skill-github-backup` | 自创 skill 同步 GitHub | skill 备份、同步、开源、上 GitHub | 7.3K ⚠️ | 含 `scripts/sync_to_github.py`；**正文超预算，待精简（细节应下沉 references）**；已固化「沙箱内 git 写操作会被静默丢弃」大坑 + 仓库破损恢复姿势 |
