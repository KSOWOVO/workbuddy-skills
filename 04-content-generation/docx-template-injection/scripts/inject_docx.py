...
FIGMAP = {
    "图2": ("fig2_flow.png",        "图2  本报告的数据采集与处理流程（本组自绘）"),
    "图3": ("fig3_pv.png",          "图3  游戏科学官方PV在哔哩哔哩的传播量级（本组采集）"),
    "图4": ("fig4_treemap.png",     "图4  内容生态结构：面积表示播放量，颜色区分内容类型（本组采集）"),
    "图5": ("fig5_top10.png",       "图5  播放量前十的内容排行（本组采集）"),
    "图6": ("fig6_interaction.png", "图6  《黑神话：悟空》13分钟实机演示的互动结构（本组采集）"),
    "图7": ("fig7_zhongkui.png",    "图7  《黑神话：钟馗》的传播走势（本组采集）"),
    "图9": ("fig9_code.png",        "图9  数据采集脚本代码（Python）"),
}
